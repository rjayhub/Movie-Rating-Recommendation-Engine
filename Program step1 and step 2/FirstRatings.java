...
public class FirstRatings {
    public ArrayList<Movie> loadMovies(String filename) {
        ...
        CSVParser parser = fr.getCSVParser();
         ...
         for (CSVRecord record: parser) {
            ...
            Movie currentMovie = new Movie(currentID, currentTitle, currentYear,
                currentGenre, currentDirector, currentCountry, currentPoster, currentMinutes);
    ...
    public void testLoadRaters () {
        ...
        System.out.println("Number  " + hashmap);
        
        
        String raterID = "2"; //rater_id
        int ratingsSize = hashmap.get(raterID).size();
        System.out.println("Number of ratings for the rater ID " + raterID + " : " + ratingsSize);
